...
final class BookListCell: UITableViewCell {
    ...
    private func setConstraints() {
        ...
        titleLabel.widthAnchor.constraint(
            equalTo: contentView.widthAnchor, multiplier: 0.7
        ).isActive = true
        ...
        authorLabel.widthAnchor.constraint(
            equalTo: contentView.widthAnchor, multiplier: 0.7
        ).isActive = true
        ...
        publishDateLabel.bottomAnchor.constraint(
            equalTo: contentView.bottomAnchor,
            constant: -indent
        ).isActive = true
        publishDateLabel.widthAnchor.constraint(
